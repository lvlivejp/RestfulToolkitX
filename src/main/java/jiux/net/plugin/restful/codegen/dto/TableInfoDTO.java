...
public class TableInfoDTO {
    ...
    private static void merge(TableInfoDTO oldData, TableInfoDTO newData) {
        ...
        if (!StringUtils.isEmpty(oldData.getSaveEntityPacakge())) {
            newData.saveEntityPacakge = oldData.getSaveEntityPacakge();
        }
    ...
    public TableInfo toTableInfo(PsiClass psiClass) {
        ...
        tableInfo.setSaveEntityPacakge(this.getSaveEntityPacakge());
    ...
    public TableInfo toTableInfo(DbTable dbTable) {
        ...
        for (ColumnInfoDTO dto : this.getFullColumn()) {
            ...
            if (columnInfo.getObj() != null && DasUtil.isAutoGenerated(columnInfo.getObj())) {
                columnInfo.setAutoGenerated(true);
            }
            tableInfo.getFullColumn().add(columnInfo);
    ...
    public static TableInfoDTO valueOf(TableInfo tableInfo) {
        ...
        dto.setSaveEntityPacakge(tableInfo.getSaveEntityPacakge());
